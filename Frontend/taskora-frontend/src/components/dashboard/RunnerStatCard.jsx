...
const RunnerStatCard = ({
  ...
  // Better trend text for Completed card
  const getTrendText = () => {
    if (label === "Completed") {
      return value === 0 ? "No earnings yet" : `₹${earnings} earned`;
    }
    return trend;
  };
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <div className="flex items-baseline gap-2 mt-2">
            ...
            {/* Only show trend if value > 0 OR if it's meaningful */}
